...
import logo from "../../assets/travelbuddy.png";
    ...
    <div className="footer w-full rounded-t-[90px] md:rounded-t-[120px] bg-purple-900">
      <div className="max-w-[1440px] mx-auto pt-10 md:pt-20 pb-5 px-10 md:px-20 text-center md:text-left md:grid grid-cols-4 gap-20">
        ...
        <div className="col-span-2 pt-10 md:pt-0">
          <h2 className="font-medium">Do You Have Questions About Travelbuddy?</h2>
          <p className="py-6 md:pr-10">Receive updates, exclusive travel deals, and expert tips directly to your inbox.</p>
          ...
          <div className="flex flex-row md:flex-row justify-between py-4 items-center">
            ...
            <div className="">
              <a className="" href="/">
                <img className="h-8 w-70" src={logo} alt="TravelBuddy Logo" />
              </a>
            </div>
          ...
          <div className="">
            ...
            <div className="py-4 ">
              ...
              <NavLink className="pt-4 text-base block" to="/about">
                <p className="text-l"> About Us</p>
              </NavLink>
              <NavLink className="pt-4 block text-base" to="/property">
                <p className="text-l">Explore Destinations</p>
              </NavLink>
              <NavLink className="pt-4 block text-base" to="/services">
                <p className="text-l">Our Services</p>
              </NavLink>
              <NavLink className="pt-4 block text-base" to="/contact">
                <p className="text-l">Contact Us</p>
              </NavLink>
              <NavLink className="pt-4 block text-base" to="/blog">
                <p className="text-l">Travel Blog</p>
              </NavLink>
      ...
      <div className="text-center py-6 text-black text-xl">
        <p>Copyright TravelBuddy 2024. All rights reserved.
        </p>
      </div>
    </div>
  );
